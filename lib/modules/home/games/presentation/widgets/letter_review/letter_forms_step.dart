        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: Center(
                  // Arabic reads right to left, so the initial form sits on
                  // the right and the final form on the left.
                  child: Directionality(
                    textDirection: TextDirection.rtl,
                    child: SizedBox(
                      height: AppDimensions.letterFormTileHeight,
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          for (final form in forms) ...[
                            Expanded(child: LetterFormTile(form: form)),
                            if (form != forms.last)
